...
import { SkillsFilter } from './components/features/SkillsFilter';
    ...
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? 'bg-gray-900 text-white' : 'bg-gradient-to-br from-blue-50 to-purple-50'}`}>
        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden md:flex space-x-8">
              <a href="#about" className={`transition-colors hover:text-blue-600 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>About</a>
              <a href="#projects" className={`transition-colors hover:text-blue-600 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>Projects</a>
              <a href="#skills" className={`transition-colors hover:text-blue-600 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>Skills</a>
              <a href="#contact" className={`transition-colors hover:text-blue-600 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>Contact</a>
              <button 
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <div className="flex justify-center space-x-8 mb-12">
            <div className="text-center">
              <div className="text-3xl font-bold text-blue-600">{stats?.projects || 0}</div>
              <div className="text-sm text-gray-500">Projects</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-blue-600">{stats?.skills || 0}</div>
              <div className="text-sm text-gray-500">Skills</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-blue-600">{stats?.experience || 0}+</div>
      ...
      {projects.length > 0 && (
        <section id="projects" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          {projects.slice(0, 6).map((project: any) => (
            <div 
              key={project.id} 
              className="glass-effect rounded-xl p-6 card-hover cursor-pointer group"
              onClick={() => {
            ...
            >
              ...
              <div className="flex space-x-4">
                {project.githubUrl && (
                  <span className="text-gray-600 text-sm">GitHub Available</span>
                )}
                {project.liveUrl && (
                  <span className="text-gray-600 text-sm">Live Demo</span>
                )}
                {project.featured && (
      ...
      {skills.length > 0 && (
        <section id="skills" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <SkillsFilter 
            skills={skills} 
            onFilterChange={(filtered) => setFilteredSkills(filtered)} 
          />
